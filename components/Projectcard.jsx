...
export default function Projectcard({ title, image, link, demo, children }) {
    return (
        <div className="group relative w-[90vw] max-w-[32rem] h-[22rem] rounded-2xl overflow-hidden shadow-lg cursor-pointer"
            ...
            {/* Text layer */}
            <div className="absolute inset-0 bg-[#1a1a2e] flex flex-col justify-center items-center px-6 text-center
